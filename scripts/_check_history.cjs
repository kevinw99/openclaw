...
(async () => {
    ...
    return Array.from(document.querySelectorAll("button, [role='button'], a"))
      ...
      .filter(
        (b) =>
          ...
          b.text.includes("查看全部") ||
          b.text.includes("View all") ||
          b.text.includes("More") ||
          b.text.includes("更多") ||
          b.text.includes("Older") ||
  ...
  for (let i = 0; i < 30; i++) {
    ...
    await page.evaluate(() => {
      ...
      const containers = document.querySelectorAll(
        "nav, aside, [class*='sidebar'], [class*='history'], [class*='scroll']",
      );
    ...
    return Array.from(document.querySelectorAll("button, [role='button'], a, div"))
      ...
      .filter(
        (b) =>
          ...
          b.text === "查看更多" ||
          b.text === "加载更多" ||
          b.text.includes("全部对话") ||
          b.text.includes("所有对话") ||
          b.href.includes("history"),
      );
  });
  ...
  for (let i = 0; i < 50; i++) {
    ...
    await page.evaluate(() => {
      const containers = document.querySelectorAll(
        "nav, aside, [class*='sidebar'], [class*='Sidebar'], [class*='scroll'], [class*='list']",
      );
